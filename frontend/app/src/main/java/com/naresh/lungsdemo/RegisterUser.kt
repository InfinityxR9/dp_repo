...
fun RegisterScreen(){
    ...
    Column {
        ...
        Row(modifier = Modifier.fillMaxWidth(),
            ...
            Text(
                text = "Create account and enjoy all the free amazing pdf tools",
                ...
                if(email.isNotEmpty()&&password.isNotEmpty()&&password.equals(confirmPassword)){
                    ...
                    addOnCompleteListener{ task->
                        ...
                        if (task.isSuccessful) {
                            ...
                            Log.d("L failed",task.exception?.message.toString())
        ...
        Row(Modifier.fillMaxWidth(),
            ...
            Image(painter = painterResource(id = R.drawable.facebook), contentDescription ="facebook",
                modifier = Modifier.size(25.dp))
            Spacer(modifier = Modifier.fillMaxWidth(0.08f))
            Image(painter = painterResource(id = R.drawable.microsoft), contentDescription ="microsoft",
                modifier = Modifier.size(25.dp))
        }
    }
}
